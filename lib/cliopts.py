...
def cmd_line_options():
	...
	ueh_group_table_list = ueh_parser.add_mutually_exclusive_group(required=False)
	...
	uev_group_table_list = uev_parser.add_mutually_exclusive_group(required=False)
